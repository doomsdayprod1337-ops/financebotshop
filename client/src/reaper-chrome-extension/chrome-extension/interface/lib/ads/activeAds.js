...
export const ActiveAds = Object.freeze([
  new Ad({
    id: 'cookie-reaper',
    text: 'Enjoying Cookie-Reaper? Get your activation key!',
    tooltip:
      'Cookie-Reaper requires activation from reaper-market.com. Get your key today.',
    url: 'https://reaper-market.com',

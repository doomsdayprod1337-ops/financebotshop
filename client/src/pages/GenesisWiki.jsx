...
const GenesisWiki = () => {
  ...
  const wikiContent = {
    overview: {
      title: "Genesis Market Overview",
      content: [
        {
          section: "What is Genesis Market?",
          text: "Genesis Market is a premium, invitation-only marketplace for stolen credentials, digital fingerprints, and cybercrime tools. Our platform provides access to high-quality stolen data from infected devices worldwide.",
          subsections: [
      ...
      content: [
        {
          ...
          text: "Creating an account on Genesis Market requires an invitation from an existing member. This ensures quality and security of our community.",
          steps: [
      ...
      content: [
        {
          ...
          text: "Earn bonuses and commissions by referring new members to Genesis Market. Our referral system rewards both you and your referrals.",
          process: [
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white">Genesis Market Wiki</h1>
          <p className="text-gray-400 mt-2">Comprehensive guide to using Genesis Market</p>
        </div>
